...
function VikingSprintMeter:OnDocumentReady()
	...
	Apollo.RegisterTimerHandler("VikingSprintMeterGracePeriod", "OnVikingSprintMeterGracePeriod", self)
	Apollo.RegisterEventHandler("VarChange_FrameCount", "OnFrame", self)
	Apollo.RegisterEventHandler("Tutorial_RequestUIAnchor", 	"OnTutorial_RequestUIAnchor", self)	

	self.wndMain = Apollo.LoadForm(self.xmlDoc, "VikingSprintMeterFormVert", "InWorldHudStratum", self)
...
function VikingSprintMeter:OnFrame()
	...
	if bWndVisible and bAtMax and not self.bJustFilled then
		...
		Apollo.StopTimer("VikingSprintMeterGracePeriod")
		Apollo.CreateTimer("VikingSprintMeterGracePeriod", 0.4, false)
...
function VikingSprintMeter:OnVikingSprintMeterGracePeriod()
	Apollo.StopTimer("VikingSprintMeterGracePeriod")
	self.bJustFilled = false
